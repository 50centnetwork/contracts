...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    event SetLockUp(uint256 newWithdrawLockupEpochs, uint256 newRewardLockupEpochs, uint256 oldWithdrawLockupEpochs, uint256 oldRewardLockupEpochs);
    ...
    function setOperator(address _operator) external onlyOperator {
        require(_operator != address(0), "Operator's address must not be address(0)");
        operator = _operator;
        emit SetOperator(_operator, msg.sender);
    }
    ...
    function setLockUp(uint256 _withdrawLockupEpochs, uint256 _rewardLockupEpochs) external onlyOperator {
        ...
        uint256 oldWithdrawLockupEpochs = withdrawLockupEpochs;
        uint256 oldRewardLockupEpochs = rewardLockupEpochs;
        withdrawLockupEpochs = _withdrawLockupEpochs;
        rewardLockupEpochs = _rewardLockupEpochs;
        emit SetLockUp(_withdrawLockupEpochs, _rewardLockupEpochs, oldWithdrawLockupEpochs, oldRewardLockupEpochs);
    }
    ...
    function governanceRecoverUnsupported(
        ...
        require(_to != address(0), "Asset should not be sent to address(0)");
